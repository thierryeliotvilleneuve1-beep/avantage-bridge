...
const lines = [
  ...
  "// [0]=Numero sequentiel [1]=Date du compte [2]=Numero fournisseur",
  "// [4]=Numero facture fournisseur [5]=Description [6]=Montant total",
  "// [33]=Numero de projet [44]=No. de commande [48]=Nom du fournisseur",
  ...
  "}",
  "",
  "// COMITE colonnes par position:",
  "// [16]=Numero sequentiel de commande [17]=Code d'activite",
  ...
  "  const toUpsert = [];",
  "",
  "  // PYBBIL — lecture par position de colonne",
  "  const pybbilRows = readPybbil(code);",
  "  console.log('[INFO] PYBBIL P' + code + ':', pybbilRows.length, 'lignes');",
  ...
  "    const montant = parseFloat(r[6]) || 0;",
  ...
  "    });",
  "  }",
  "  console.log('[INFO] PYBBIL apres filtre division:', toUpsert.length);",
  "",
  "  // TRANS type E et B",
  ...
  "      return true;",
  "    });",
  "    console.log('[INFO] TRANS E/B P' + code + ' div=' + (divisionFilter||'toutes') + ':', filtered.length);",
...
console.log('OK - trans-sync.js v9 ecrit (PYBBIL par position)');
