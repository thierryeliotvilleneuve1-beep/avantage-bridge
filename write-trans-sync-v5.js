...
const lines = [
  ...
  "}",
  "",
  "// Route normale — toutes les divisions",
  ...
  "  // Si divisionFilter, on ne peut pas filtrer PYBBIL par division (pas de code activite dans PYBBIL)",
  "  // On inclut toutes les P si pas de filtre division",
  "  if (!divisionFilter) {",
  ...
  "      toUpsert.push({",
  "        projet_id: projetId, controle_budgetaire_id: null, bon_de_commande_id: bcId,",
  "        code_division: '', date_transaction: dateRaw, numero_journal: numSeq,",
  "        numero_facture: numFacture, fournisseur: fournisseur, description: description,",
  "        montant: montant, type_transaction: 'P', numero_gl: '33200', is_mo: false,",
  "        numero_commande_avantage: numCommande, sync_avantage_ts: new Date().toISOString(),",
  "      });",
  "    }",
  "  }",
  "",
  ...
  "  }",
  "",
  "  console.log('[INFO] trans-sync: ' + toUpsert.length + ' transactions pour P' + code + (divisionFilter ? ' div=' + divisionFilter : ''));",
  "",
...
console.log('OK - trans-sync.js v5 ecrit avec filtre division optionnel');
