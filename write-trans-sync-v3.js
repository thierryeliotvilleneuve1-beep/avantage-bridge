...
const lines = [
  ...
  "  const toUpsert = [];",
  "",
  "  // PYBBIL — factures fournisseurs liées aux BCs",
  ...
  "    const kCommande = keys.find(k => k.toLowerCase().includes('commande') && !k.toLowerCase().includes('plusieurs'));",
  ...
  "  }",
  "",
  "  // TRANS type E et B — MO et banque",
